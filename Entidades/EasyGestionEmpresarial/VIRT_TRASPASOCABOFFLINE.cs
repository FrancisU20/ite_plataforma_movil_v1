...
{
    [Table("VIRT_TRASPASOCABOFFLINE")]
    public partial class VIRT_TRASPASOCABOFFLINE
    {
        public VIRT_TRASPASOCABOFFLINE()
        {
            this.VIRT_TRASPASODETOFFLINE = new List<VIRT_TRASPASODETOFFLINE>();
        }
        [Key, Column(Order = 0)]
        ...
        public string vtc_numero_pedido_sap { get; set; }
        public Nullable<long> tr_secuencial_operador { get; set; }
        public virtual ICollection<VIRT_TRASPASODETOFFLINE> VIRT_TRASPASODETOFFLINE { get; set; }
    }
}
