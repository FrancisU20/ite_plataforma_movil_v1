...
namespace Entidades.EasyGestionEmpresarial
{
    ...
    public partial class VIRT_TRASPASOCABFarmacia 
    {
        public VIRT_TRASPASOCABFarmacia()
        {
            this.VIRT_TRASPASODETFarmacia = new List<VIRT_TRASPASODETFarmacia>();
        }
        ...
        public virtual ICollection<VIRT_TRASPASODETFarmacia> VIRT_TRASPASODETFarmacia { get; set; }
    }
}
