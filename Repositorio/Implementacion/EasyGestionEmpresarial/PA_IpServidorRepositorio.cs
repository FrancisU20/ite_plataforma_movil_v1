...
{
    public class PA_IpServidorRepositorio : Repositorio<PV_IpServidor>, IPA_IpServidorRepositorio
    {
        public PA_IpServidorRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
