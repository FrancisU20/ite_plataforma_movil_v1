...
{
    public class tbl_LoginUsuarioRepositorio : Repositorio<tbl_LoginUsuario>, Itbl_LoginUsuarioRepositorio
    {
        public tbl_LoginUsuarioRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
