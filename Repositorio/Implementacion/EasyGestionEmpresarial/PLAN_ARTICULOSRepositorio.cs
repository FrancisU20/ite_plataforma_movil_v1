...
{
    public class PLAN_ARTICULOSRepositorio : Repositorio<PLAN_ARTICULOS>, IPLAN_ARTICULOSRepositorio
    {
        public PLAN_ARTICULOSRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
