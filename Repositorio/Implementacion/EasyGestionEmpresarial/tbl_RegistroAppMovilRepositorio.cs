...
{
    public class tbl_RegistroAppMovilRepositorio : Repositorio<tbl_RegistroAppMovil>, Itbl_RegistroAppMovilRepositorio
    {
        public tbl_RegistroAppMovilRepositorio(EasyContextoFarmacia context)
            : base(context)
        {
        }
