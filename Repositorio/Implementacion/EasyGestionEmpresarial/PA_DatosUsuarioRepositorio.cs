...
{
    public class PA_DatosUsuarioRepositorio : Repositorio<PA_DatosUsuario>, IPA_DatosUsuarioRepositorio
    {
        public PA_DatosUsuarioRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
