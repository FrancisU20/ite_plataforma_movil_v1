...
{
    public class PLAN_FACTURACIONRepositorio : Repositorio<PLAN_FACTURACION>, IPLAN_FACTURACIONRepositorio
    {
        public PLAN_FACTURACIONRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
