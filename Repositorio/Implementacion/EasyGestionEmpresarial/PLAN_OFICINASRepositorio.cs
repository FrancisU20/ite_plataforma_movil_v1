...
{
    public class PLAN_OFICINASRepositorio : Repositorio<PLAN_OFICINAS>, IPLAN_OFICINASRepositorio
    {
        public PLAN_OFICINASRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
