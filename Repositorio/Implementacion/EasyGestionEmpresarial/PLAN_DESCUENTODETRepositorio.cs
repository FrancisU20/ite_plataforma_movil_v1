...
{
    public class PLAN_DESCUENTODETRepositorio : Repositorio<PLAN_DESCUENTODET>, IPLAN_DESCUENTODETRepositorio
    {
        public PLAN_DESCUENTODETRepositorio(EasyContextoFarmacia contexto)
            : base(contexto)
        {
        }
