...
{
    public class tbl_detallefactRepositorio : Repositorio<tbl_detallefact>, Itbl_detallefactRepositorio
    {
        public tbl_detallefactRepositorio(EasyContextoFarmacia context)
            : base(context)
        {
        }
