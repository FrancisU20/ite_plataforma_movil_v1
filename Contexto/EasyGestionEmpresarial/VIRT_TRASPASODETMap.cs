...
{
    public class VIRT_TRASPASODETMap : EntityTypeConfiguration<VIRT_TRASPASODET>
    {
        public VIRT_TRASPASODETMap()
        {
            // Primary Key
            ...
            //// Relationships
            //this.HasRequired(t => t.VIRT_TRASPASOCAB)
            //    .WithMany(t => t.VIRT_TRASPASODET)
