...
{
    public class VIRT_TRASPASODETFarmaciaMap : EntityTypeConfiguration<VIRT_TRASPASODETFarmacia>
    {
        public VIRT_TRASPASODETFarmaciaMap()
        {
            // Primary Key
            ...
            // Relationships
            this.HasRequired(t => t.VIRT_TRASPASOCABFarmacia)
                .WithMany(t => t.VIRT_TRASPASODETFarmacia)
                .HasForeignKey(d => new { d.TR_FOL, d.TR_TIPOMOV ,d.ID_BODEGA_ORG});
        }
    }
}
