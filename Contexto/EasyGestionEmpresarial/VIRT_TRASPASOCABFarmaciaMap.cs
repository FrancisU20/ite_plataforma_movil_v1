...
{
    public class VIRT_TRASPASOCABFarmaciaMap : EntityTypeConfiguration<VIRT_TRASPASOCABFarmacia>
    {
        public VIRT_TRASPASOCABFarmaciaMap()
        {
            // Primary Key
